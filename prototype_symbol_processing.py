...
print("orb1  took ", (endorb1 - start) * 10**3, "ms")
print("orb2  took ", (endorb2 - endorb1) * 10**3, "ms")
print("Flann took ", (endflann - endorb2) * 10**3, "ms")
print("Lowes took ", (endlowes - endflann) * 10**3, "ms")
